...
class DatabaseManager:
    ...
    def save_workflow_version(self, session_id: str, workflow_data: Dict[str, Any],
                              workflow_data_ui: Dict[str, Any] = None,
    ...
    def update_workflow_version(self, version_id: int, workflow_data: Dict[str, Any],
...
def save_workflow_data(session_id: str, workflow_data: Dict[str, Any], workflow_data_ui: Dict[str, Any] = None,
                       attributes: Optional[Dict[str, Any]] = None) -> int:
    """保存工作流数据的便捷函数"""
